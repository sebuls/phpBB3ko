...
$lang = array_merge($lang, array(
	...
	'COPY_PERMISSIONS_TO'	=> '다음으로 권한 적용',
	...
	'DISPLAY_ROLE_ITEMS'	=> '이 역할 쓰는 아이템 보기',

	'EDIT_PERMISSIONS'	=> '권한 편집',
	'EDIT_ROLE'		=> '역할 편집',

	'GROUPS_NOT_ASSIGNED'	=> '이 역할 할당된 그룹 없음',

	'LOOK_UP_GROUP'		=> '사용자 그룹 검색',
	'LOOK_UP_USER'		=> '사용자 검색',

	'MANAGE_GROUPS'		=> '그룹 관리',
	'MANAGE_USERS'		=> '사용자 관리',

	'NO_AUTH_SETTING_FOUND'	=> '권한 설정 정의 안 됨.',
	'NO_ROLE_ASSIGNED'	=> '할당된 역할 없음…',
	'NO_ROLE_ASSIGNED_EXPLAIN'	=> '이 역할로 설정해도 오른쪽의 권한은 변경되지 않습니다. 모든 권한을 설정 해제/제거하려면 “All <strong>NO</strong>” 링크를 사용해야 합니다.',
	'NO_ROLE_AVAILABLE'		=> '가능한 역할 없음',
	'NO_ROLE_NAME_SPECIFIED'	=> '역할에 이름을 주세요.',
	'NO_ROLE_SELECTED'		=> '역할 못 찾음.',
	'NO_USER_GROUP_SELECTED'	=> '사용자 또는 그룹 선택 안 함.',

	'ONLY_FORUM_DEFINED'	=> '선택한 포럼만 정의했습니다. 또한 사용자 또는 그룹을 하나 이상 선택하십시오..',

	'PERMISSION_APPLIED_TO_ALL'	=> '사용 권한 및 역할은 확인된 모든 개체에도 적용됩니다',
	...
	'SELECTED_FORUM_NOT_EXIST'	=> '선택된 포럼 없음.',
	'SELECTED_GROUP_NOT_EXIST'	=> '선택된 그룹 없음.',
	'SELECTED_USER_NOT_EXIST'	=> '선택된 사용자 없음.',
	'SELECT_FORUM_SUBFORUM_EXPLAIN'	=> '여기서 선택한 포럼에는 선택 항목에 모든 하위 포럼이 포함됩니다.',
	'SELECT_ROLE'			=> '역할 선택…',
	'SELECT_TYPE'			=> '유형 선택',
	...
	'TRACE_DEFAULT'	=> '기본적으로 모든 권한은 <strong>NO</strong>(설정되지 않음)이므로 다른 설정으로 권한을 덮어쓸 수 있습니다..',
	'TRACE_FOR'			=> 'Trace for',
