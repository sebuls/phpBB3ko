...
$lang = array_merge($lang, array(
	'ACP_BOARD_SETTINGS_EXPLAIN'	=> '여기에서 보드의 기본 동작을 결정하고 적절한 이름과 설명을 제공하며 다른 설정 중에서 시간대와 언어의 기본값을 조정할 수 있습니다.',
	'BOARD_INDEX_TEXT'		=> '보드 인덱스 텍스트',
	'BOARD_INDEX_TEXT_EXPLAIN'	=> '이 텍스트는 보드의 이동 경로에서 보드 인덱스로 표시됩니다. 지정하지 않으면 기본적으로 "보드 색인"이 됩니다.',
	'BOARD_STYLE'			=> '보드 스타일',
	'CUSTOM_DATEFORMAT'		=> '맞춤…',
	'DEFAULT_DATE_FORMAT'		=> '날짜 형식',
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> '날짜 형식은 PHP <code><a href="https://www.php.net/manual/datetime.format.php">date functions</a>와 같습니다..',
	'DEFAULT_LANGUAGE'		=> '기본 언어',
	'DEFAULT_STYLE'			=> '기본 스타일',
	'DEFAULT_STYLE_EXPLAIN'		=> '새 사용자 기본 스타일.',
	'DISABLE_BOARD'			=> '보드 비활성',
	'DISABLE_BOARD_EXPLAIN'		=> '이렇게 하면 관리자나 중재자가 아닌 사용자가 보드를 사용할 수 없게 됩니다. 원하는 경우 짧은(255자) 메시지를 입력하여 표시할 수도 있습니다.',
	'DISPLAY_LAST_SUBJECT'		=> '포럼 목록에 마지막으로 추가된 게시물의 제목 표시',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> '최근 추가된 게시물의 제목이 게시물에 대한 하이퍼링크와 함께 포럼 목록에 표시됩니다. 암호로 보호된 포럼 및 사용자에게 읽기 액세스 권한이 없는 포럼의 주제는 표시되지 않습니다.',
	'DISPLAY_UNAPPROVED_POSTS'	=> '승인되지 않은 게시물 작성자에게 표시',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> '승인되지 않은 게시물은 작성자가 볼 수 있습니다. 게스트 게시물에는 적용되지 않습니다.',
	'GUEST_STYLE'			=> '손님 스타일',
	'GUEST_STYLE_EXPLAIN'		=> '손님용 보드 스타일.',
	'OVERRIDE_STYLE'		=> '사용자 스타일 무시',
	'OVERRIDE_STYLE_EXPLAIN'	=> '사용자(및 손님) 스타일을 "기본 스타일"에 정의된 스타일로 바꿉니다".',
	'SITE_DESC'			=> '사이트 설명',
	'SITE_HOME_TEXT'		=> '메인 웹사이트 텍스트',
	'SITE_HOME_TEXT_EXPLAIN'	=> '이 텍스트는 보드의 이동 경로에서 웹사이트 홈페이지에 대한 링크로 표시됩니다. 지정하지 않으면 기본적으로 “Home”이 됩니다.',
	'SITE_HOME_URL'			=> '메인 웹사이트 URL',
	'SITE_HOME_URL_EXPLAIN'		=> '지정하면 이 URL에 대한 링크가 보드의 이동 경로 앞에 추가되고 보드 로고가 포럼 색인 대신 이 URL에 연결됩니다. 절대 URL이 필요합니다. 예 <samp>http://www.phpbb.com</samp>.',
	'SITE_NAME'			=> '사이트 이름',
	'SYSTEM_TIMEZONE'		=> '손님 시간대',
	'SYSTEM_TIMEZONE_EXPLAIN'	=> '로그인하지 않은 사용자(손님, 봇)에게 시간을 표시하는 데 사용할 시간대입니다. 로그인한 사용자는 등록 중에 시간대를 설정하고 사용자 제어판에서 변경할 수 있습니다.',
	'WARNINGS_EXPIRE'		=> '경고 기간',
	'WARNINGS_EXPIRE_EXPLAIN'	=> '경고가 사용자 기록에서 자동으로 만료되기 전까지 경과할 일 수입니다. 이 값을 0으로 설정하 경고가 영구적으로 됩니다..',
));

// Board Features
$lang = array_merge($lang, array(
	'ACP_BOARD_FEATURES_EXPLAIN'	=> '여기에서 여러 보드 기능을 활성화/비활성화할 수 있습니다.',

	'ALLOW_ATTACHMENTS'		=> '첨부 허용',
	'ALLOW_BIRTHDAYS'		=> '생일 허용',
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> '프로필에 생일을 입력하고 나이를 표시하도록 허용합니다. 게시판 인덱스 내 생일 목록은 별도의 불러오기 설정으로 관리되는 점 주의 바랍니다.',
	'ALLOW_BOOKMARKS'		=> '주제 북마크 허용',
	'ALLOW_BOOKMARKS_EXPLAIN'	=> '사용자가 개인 북마크를 저장할 수 있습니다.',
	'ALLOW_BBCODE'			=> 'BBCode 허용',
	'ALLOW_FORUM_NOTIFY'		=> '포럼 구독 허용',
	'ALLOW_NAME_CHANGE'		=> '사용자 이름 변경 허용',
	'ALLOW_NO_CENSORS'		=> '단어 검열 비활성화 허용',
	'ALLOW_NO_CENSORS_EXPLAIN'	=> '사용자가 게시물 및 개인 메시지의 자동 단어 검열을 비활성화하도록 선택할 수 있습니다.',
	'ALLOW_PM_ATTACHMENTS'		=> '개인 메시지에 첨부 파일 허용',
	'ALLOW_PM_REPORT'		=> '사용자가 개인 메시지를 보고하도록 허용',
	'ALLOW_PM_REPORT_EXPLAIN'	=> '이 설정이 활성화되면 사용자는 보드의 중재자에게 받거나 보낸 개인 메시지를 보고할 수 있습니다. 이러한 개인 메시지는 중재자 제어판에서 볼 수 있습니다.',
	'ALLOW_QUICK_REPLY'		=> '빠른 답장 허용',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> '이 스위치를 사용하면 보드 전체에서 빠른 응답을 비활성화할 수 있습니다. 사용하도록 설정하면 개별 포럼에 빠른 답장을 표시할지 여부를 결정하는 데 포럼 관련 설정이 사용됩니다.',
