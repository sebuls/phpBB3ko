...
$lang = array_merge($lang, array(
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS'	=> '글로벌 중재 권한 보기View global moderation permissions',
	...
	'CRON_LOCK_ERROR'		=> 'Could not obtain cron lock 얻을 수 없음.',
	'CRON_NO_SUCH_TASK'		=> 'Could not find cron task “%s” 못 찾음.',
	'CRON_NO_TASK'			=> '지금 cron tasks 돌릴 필요 없음need to be run right now.',
	'CRON_NO_TASKS'			=> 'cron tasks 못 찾음.',
	'CSV_INVALID'			=> '쉼표 구분 설정 “%1$s” 틀림. 값을 쉼표로 구분해야 하며 선행 또는 후행 구분자를 넣으면 안 됩니다.',
	'CURRENT_VERSION'		=> '현 버전',
