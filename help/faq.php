...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_POSTING_BUMP_ANSWER'	=> '“Bump topic”링크를 볼 때 그 링크를 클릭하면 첫 페이지의 포럼 맨 위에 주제를 “bump”할 수 있습니다. 그러나 이것이 안 보이면 주제 bump가 비활성화되거나 bump 간의 시간 허용에 아직 도달하지 못했습니다. 주제에 회신하여 주제를 단순히 bump 할 수도 있지만, 그렇게 할 때는 보드 규칙을 따라야합니다.',
	'HELP_FAQ_POSTING_BUMP_QUESTION'	=> '어떻게 내 주제가 bump 하나요?',
	'HELP_FAQ_POSTING_CREATE_ANSWER'	=> '포럼에 새 주제를 게시하려면 "New Topic"를 클릭하십시오. 주제에 대한 답장을 게시하려면 "Post Reply"를 클릭하십시오. 메시지를 게시하기 전에 등록해야 할 수도 있습니다. 각 포럼의 권한 목록은 포럼 및 주제 화면의 하단에 있습니다. 예 : 새로운 주제를 게시 할 수 있고 첨부 파일 등을 게시 할 수 있습니다.',
	...
	'HELP_FAQ_POSTING_REPORT_QUESTION'	=> '중재자에게 게시물을 보고하려면?',
