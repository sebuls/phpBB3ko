...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_DEACTIVATED'		=> '계정이 수동으로 비활성화되어서 관리자에 의해서만 활성화시킬수 있습니다.',
	'ACP'						=> '관리자 제어판',
	'ACP_SHORT'					=> 'ACP',
	'ACTIVE'					=> '활성',
	'ACTIVE_ERROR'					=> '지정된 사용자 이름은 현재 비활성화되어 있습니다. 계정 활성화에 문제가 있으면 게시판 관리자에게 문의하세요.',
	'ADMINISTRATOR'					=> '관리자',
	'ADMINISTRATORS'				=> '관리자',
	'AGE'						=> '나이',
	'AIM'						=> 'AIM',
	'AJAX_ERROR_TITLE'				=> 'AJAX 에러',
	'AJAX_ERROR_TEXT'				=> '요청을 처리하는동안 문제 발생.',
	'AJAX_ERROR_TEXT_ABORT'			=> '사용자가 요청을 중지.',
	'AJAX_ERROR_TEXT_TIMEOUT'		=> '요청 시간 초과; 다시 시도하세요.',
	'AJAX_ERROR_TEXT_PARSERERROR'	=> '요청에서 잘못되어서 서버가 그른 응답을 했습니다.',
	'ALLOWED'					=> '허용됨',
	'ALL_FILES'					=> '모든 파일',
	'ALL_FORUMS'					=> '모든 포럼',
	'ALL_MESSAGES'					=> '모든 메시지',
	'ALL_POSTS'					=> '모든 글',
	'ALL_TIMES'					=> '모든 시간 <span title="%2$s">%1$s</span>',
	'ALL_TOPICS'					=> '모든 주제',
	'ALT_TEXT'					=> '대체 텍스트',
	'AND'						=> '그리고',
	'ARE_WATCHING_FORUM'			=> '이 포럼 새 글을 알리도록 구독.',
	'ARE_WATCHING_TOPIC'			=> '이 주제 새 글을 알리도록 구독.',
	'ASCENDING'				=> '오름차순',
	'ATTACHMENTS'				=> '첨부',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> '첨부가 틀림.',
	'AUTHOR'				=> '저자',
	'AUTH_NO_PROFILE_CREATED'		=> '사용자 프로필 생성 실패.',
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'			=> '이 외부 서비스는 다른 보드 계정과 연결되었습니다.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'			=> '틀린 데이터베이스 항목.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> '틀린 유형을 OAuth 서비스 핸들러에 제공했습니다.',
	'AUTH_PROVIDER_OAUTH_ERROR_REQUEST'				=> 'OAuth 요청을 처리하는데 무엇인가가 틀렸습니다.',
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'				=> '이 외부 서비스가 틀린 값을 반환해서 요청을 진행할 수 없음.',
	'AUTH_PROVIDER_OAUTH_ERROR_SERVICE_NOT_CREATED'			=> 'OAuth 서비스 생성 안 됨',
	...
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_NOT_STORED'			=> 'OAuth 토큰 저장 안 됨.',
	'AUTH_PROVIDER_OAUTH_TOKEN_ERROR_INCORRECTLY_STORED'	=> 'OAuth 토큰 잘 못 저장됨.',
	'AVATAR_DISALLOWED_CONTENT'		=> '업로드가 거부되었는데 왜녀면 업로드된 파일이 공격 벡터로 인식되었기 때문.',
	'AVATAR_DISALLOWED_EXTENSION'		=> '이 파일은 표시할 수 없는데 왜냐면 외부 <strong>%s</strong> 허용 안 됨.',
	'AVATAR_EMPTY_REMOTE_DATA'		=> '아바타를 업로드 할 수 없는데 왜냐면 원격 데이터 잘 못 됨.',
	'AVATAR_EMPTY_FILEUPLOAD'		=> '업로드된 파일이 비었음.',
	'AVATAR_INVALID_FILENAME'		=> '%s 틀린 파일 이름.',
	'AVATAR_NOT_UPLOADED'			=> 'Avatar 업로드 불가.',
	'AVATAR_NO_TEMP_DIR'			=> '임시 파일 못 찾거나 쓰기 불가.',
	'AVATAR_NO_SIZE'			=> '연결된 아바타 너비 또는 높이 결정 불가.수동으로 넣으세요.',
	'AVATAR_NO_UPLOAD_DIR'			=> '아바타 저장경로가 없거나 쓰기 불가.',
	'AVATAR_NO_UPLOAD_PATH'			=> '아바타 업로드가 가능하지만 아바타 경로가 설정 안 됨.',
	'AVATAR_PARTIAL_UPLOAD'			=> '파일이 부분적으로만 업로드됨.',
	'AVATAR_PHP_SIZE_NA'			=> '아바타 파일 크기 너무 큼<br />php.ini 에 설정된 최대 허융 파일 크기를 결정할 수 없음.',
	'AVATAR_PHP_SIZE_OVERRUN'		=> '아바타 파일 크기 너무 큼. 최대 허용 업로드 크기 %1$d %2$s.<br />이것은 php.ini 에 있고 무시할 수 없음.',
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> '아바타 업로드 불가 왜냐면 요청 시간 지남.',
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'PHP 확장이 파일 업로드를 멈춤.',
	'AVATAR_URL_INVALID'			=> 'URL 틀림.',
	'AVATAR_URL_NOT_FOUND'			=> '파일 못 찾음.',
	'AVATAR_WRONG_FILESIZE'			=> '아바타 파일 크기 0 과 %1$d %2$s 사이.',
	'AVATAR_WRONG_SIZE'			=> '제출 아바타 너비 %5$s 높이 %6$s. 아바타는 적어도 %1$s 너비 및 %2$s 높이, 그러나 %3$s 너비 %4$s 높이 이상이어야 함.',

	'BACK_TO_TOP'			=> '꼭대기',
	'BACK_TO_PREV'			=> '이전 페이지로',
	'BAN_TRIGGERED_BY_EMAIL'	=> 'email 주소 차단됨.',
	'BAN_TRIGGERED_BY_IP'		=> 'IP 주소 차단됨.',
	'BAN_TRIGGERED_BY_USER'		=> '사용자 이름 자단됨.',
	'BBCODE_GUIDE'			=> 'BBCode 가이드',
	'BCC'				=> 'BCC',
	'BIRTHDAYS'			=> '생일',
	'BOARD_BAN_PERM'		=> '<strong>영구적으로</strong> 이 게시판에서 차단됨.<br /><br />%2$s보드 관리자%3$s 에게 연락하세요.',
	'BOARD_BAN_REASON'		=> '차단 사유: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> '이 게시판에서 <strong>%1$s</strong>까지 차단됨.<br /><br />%2$s보드 관리자%3$s 에게 연락하세요.',
	'BOARD_DISABLE'			=> '이 게시판 현재 사용 불가.',
	'BOARD_DISABLED'		=> '이 게시판은 현재 사용 불가.',
	'BOARD_UNAVAILABLE'		=> '이 게시판 임시 사용 불가, 몇 분 후에 다시 시도하세요.',
	'BROWSING_FORUM'		=> '이 포럼 사용자: %1$s',
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> '이 포럼 검색 사용자: %2$s 와 %1$d 손님',
		2	=> '이 포럼 검색 사용자: %2$s 와 %1$d 손님',
	),
	'BUTTON_DELETE'         => '삭제',
	'BUTTON_EDIT'		=> '편집',
	...
	'CHANGING_PREFERENCES'	=> '게시판 기본 설정 변경',
	...
	'CONFIRM'			=> '확인',
	'CONFIRM_CODE'			=> '확인 코드',
	'CONFIRM_CODE_EXPLAIN'	=> '나타난 코드를 넣으세요. 대소문자 구분 없음.',
	'CONFIRM_CODE_WRONG'	=> '코드 틀림.',
	'CONFIRM_OPERATION'	=> '이 작업을 하겠습니까?',
	'CONFIRM_AVATAR_DELETE' => '아바타 지우겠습니까?',
	'CONGRATULATIONS'	=> '축하 ',
	...
	'CONTACT_USER'		=> '연락 %s',
	'CONTACT_US'		=> '우리에게 연락',
	'COOKIE_CONSENT_INFO'	=> '더 배우기',
	'COOKIE_CONSENT_MSG'	=> '이 사이트는 쿠키를 써서 최상의 경험을 얻게 합니다.',
	'COOKIE_CONSENT_OK'	=> 'Got it!',
	'COOKIE_CONSENT_HREF'	=> 'http://cookiesandyou.com',
	'COOKIES_DELETED'		=> '모든 게시판 쿠키 삭제됨.',
	'CURRENT_TIME'			=> '현재 %s',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> '이메일 도메인은 바른 MX 레코드 없음.',
	'DOWNLOADED'			=> '다운로드됨',
	...
	'EMAIL_INVALID_EMAIL'				=> '메일 주소 틀림.',
	'EMAIL_SMTP_ERROR_RESPONSE'			=> '메일 보내다가<strong> %1$s행</strong>에서 문제 발생. 응답: %2$s.',
	'EMPTY_SUBJECT'					=> '새 글 쓸 때 주제를 쓰세요.',
	'EMPTY_MESSAGE_SUBJECT'				=> '새 메시지를 조합할 때 주제를 쓰세요.',
	'ENABLED'					=> '활성화',
	'ENCLOSURE'					=> 'Enclosure',
	'ENTER_USERNAME'				=> '사용자 이름 입력',
	'ERR_CHANGING_DIRECTORY'			=> '디렉터리 변경 불가.',
	'ERR_CONNECTING_SERVER'				=> '서버 연결 에러.',
	'ERR_JAB_AUTH'						=> 'Jabber 서버에 권한부여 안 됨.',
	'ERR_JAB_CONNECT'					=> 'Jabber 서버 연결 안 됨.',
	'ERR_UNABLE_TO_LOGIN'				=> '사용자 이름 또는 패스워드 틀림.',
	'ERR_UNWATCHING'					=> '구독취소 오류.',
	'ERR_WATCHING'						=> '구독 시도 오류.',
	'ERR_WRONG_PATH_TO_PHPBB'			=> 'phpBB 경로 틀림.',
	'ERROR'						=> '에러',
	'EXPAND_VIEW'						=> '보기 확장',
	'EXTENSION'							=> '확장',
	'EXTENSION_DISABLED'				=> '확장 <strong>%s</strong>이 활성화 안 됨',
	'EXTENSION_DISABLED_AFTER_POSTING'	=> '확장 <strong>%s</strong>이 비활성화되어 더 이상 나타나지 않습니다.',
	'EXTENSION_DOES_NOT_EXIST'			=> '확장 <strong>%s</strong> 없음.',

	'FACEBOOK'				=> 'Facebook',
	'FAQ'					=> 'FAQ',
	'FAQ_EXPLAIN'			=> '자주 묻는 질문',
	'FEATURE_NOT_AVAILABLE' => '요청 기능은 이 게시판에 쓸 수 없음.',
	'FILENAME'				=> '파일명',
	'FILESIZE'				=> '파일 크기',
	'FILEDATE'				=> '파일 날짜',
	'FILE_COMMENT'			=> '파일 댓글',
	'FILE_CONTENT_ERR'		=> '파일 내용 못 읽음: %s',
	'FILE_JSON_DECODE_ERR'	=> 'json 파일 디코딩 실패: %s',
	'FILE_NOT_FOUND'		=> '요청 파일 못 찾음: %s',
	'FIND_USERNAME'			=> '회원 찾기',
	'FOLDER'			=> '폴더',
	'FORGOT_PASS'			=> '패스워드 잊음',
	'FORM_INVALID'			=> '제출 폼 틀림. 다시 하세요.',
	'FORUM'					=> '포럼',
	'FORUMS'				=> '포럼',
	'FORUMS_MARKED'			=> '포럼은 읽은 것으로 표시되었습니다.',
	'FORUM_CAT'				=> '포럼 카테고리',
	'FORUM_INDEX'			=> '보드 인덱스',
	'FORUM_LINK'			=> '포럼 링크',
	...
	'FORUM_LOCKED'			=> '포럼 잠김',
	'FORUM_RULES'			=> '포럼 규칙',
	'FORUM_RULES_LINK'		=> '여기를 클릭해서 포럼규칙 보세ㅇ',
	'FROM'					=> '부터',
	'FSOCK_DISABLED'		=> '기능을 완성할 수 없는데 왜냐면  <var>fsockopen</var> 이 비활성화 되었거나 쿼리 서버 찾을 수 없음.',
	'FSOCK_TIMEOUT'			=> '네트워크 스트림에서 읽다가 타임아웃 발생.',

	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'		=> '파일 그룹 변경 불가',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> '권한 변경 풀가',
	'FILESYSTEM_CANNOT_COPY_FILES'				=> '파일 복사 불가',
	'FILESYSTEM_CANNOT_CREATE_SYMLINK'			=> 'symlink 생성 불가',
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'		=> '디렉터리 생성 불가',
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> '시스템에서 파일 삭제 불가',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> '파일 덤프 불가',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> '디렉터리 미러 불가',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> '파일 이름 변경 불가',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> '파일 생성 또는 타임스탬프 변경 불가',

	'FTP_FSOCK_HOST'				=> 'FTP 호스트',
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'FTP 서버는 사이트를 연결할 때 씁니다.',
	'FTP_FSOCK_PASSWORD'			=> 'FTP 패스워드',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> 'FTP 사용자 패스워드.',
	'FTP_FSOCK_PORT'				=> 'FTP 포트',
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Port는 서버에 연결할 때 씁니다.',
	'FTP_FSOCK_ROOT_PATH'			=> 'phpBB 경로',
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'root에서 phpBB board까지 경로.',
	'FTP_FSOCK_TIMEOUT'			=> 'FTP timeout',
	'FTP_FSOCK_TIMEOUT_EXPLAIN'		=> '시간 초, 서버 응답을 기다리는.',
	'FTP_FSOCK_USERNAME'			=> 'FTP 사용자 명',
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> '서버에 연결하는 사용자명.',

	'FTP_HOST'					=> 'FTP 호스트',
	'FTP_HOST_EXPLAIN'			=> 'FTP 서버는 사이트 연결할 때 씀.',
	'FTP_PASSWORD'				=> 'FTP 패스워드',
	'FTP_PASSWORD_EXPLAIN'		=> 'FTP 사용자명에 대한 암호.',
	'FTP_PORT'				=> 'FTP port',
	'FTP_PORT_EXPLAIN'			=> '서버 연결할 포트.',
	'FTP_ROOT_PATH'				=> 'phpBB 경로',
	'FTP_ROOT_PATH_EXPLAIN'		=> 'root 에서 phpBB board까지 경로.',
	'FTP_TIMEOUT'				=> 'FTP 타임아웃',
	'FTP_TIMEOUT_EXPLAIN'		=> '시스템이 서버의 응답을 기다리는 시간 초.',
	'FTP_USERNAME'				=> 'FTP 사용자명',
	'FTP_USERNAME_EXPLAIN'		=> '서버에 연결하는 사용자명.',

	'GENERAL_ERROR'				=> '일반 에러',
	'GB'					=> 'GB',
	'GIB'					=> 'GiB',
	'GO'					=> '가기',
	'GOTO_FIRST_POST'			=> '첫 게시물로 가기',
	'GOTO_LAST_POST'			=> '마지막 게시물로 가기',
	'GOTO_PAGE'				=> '페이지로 가기',
	'GROUP'					=> '그룹',
	'GROUPS'				=> '그룹',
	'GROUP_ERR_TYPE'			=> '부적절한 그룹 유형.',
	'GROUP_ERR_USERNAME'		=> '그룹 이름 없음.',
	'GROUP_ERR_USER_LONG'		=> '그룹 이름이 60자 넘을 수 없습니다.',
	'GUEST'				=> '손님',
	...
	'G_GUESTS'				=> '손님',
	'G_REGISTERED'				=> '등록 사용자',
	'G_REGISTERED_COPPA'		=> '등록 COPPA 사용자',
	'G_GLOBAL_MODERATORS'		=> '광역 중재자',
	'G_NEWLY_REGISTERED'		=> '새 등록 사용자',
	...
	'IF'				=> 'If',
	'IMAGE'				=> 'Image',
	'IMAGE_FILETYPE_INVALID'	=> '파일유형 %d은 mimetype %s를 지원 안 합니다.',
	'IMAGE_FILETYPE_MISMATCH'	=> '이미지파일유형 불일치: 예상 확장 %1$s 그러나 확장은 %2$s 주어짐.',
	'IN'				=> 'in',
	'INACTIVE'			=> '비활성',
	'INDEX'				=> '인덱스 페이지',
	'INFORMATION'			=> '정보',
	'INSECURE_REDIRECT'		=> '잠재적으로 위험한 url로 리디렉션 시도.',
	'INTERESTS'			=> 'Interests',
	...
	'INVALID_PLURAL_RULE'		=> '선택한 복수규칙 부당. 타당한 값 0 과 15 사이 정수.',
	'IP'						=> 'IP',
	'IP_BLACKLISTED'			=> '당신의 IP %1$s 차단되었습니다. 자세한 내용 <a href="%2$s">%2$s</a>.',

	'JABBER'				=> 'Jabber',
	'JOINED'				=> 'Joined',
	'JUMP_PAGE'				=> '가려는 페이지 번호 입력',
	'JUMP_TO'				=> '가기',
	'JUMP_TO_PAGE'			=> '페이지로 가기',
	'JUMP_TO_PAGE_CLICK'	=> '클릭해서 갈 페이지…',
	...
	'LAST_VISIT'				=> '최근 방문',
	'LDAP_NO_LDAP_EXTENSION'		=> 'LDAP 확장 불가.',
	'LDAP_NO_SERVER_CONNECTION'		=> 'LDAP 서버 연결 불가.',
	'LDAP_SEARCH_FAILED'			=> 'LDAP 디렉터리 검색 에러.',
	'LEGEND'				=> 'Legend',
	'LIVE_SEARCHES_NOT_ALLOWED'		=> '실시간 검색 불가.',
	'LOADING'				=> 'Loading',
	'LOCATION'					=> 'Location',
	'LOCK_POST'				=> '글 잠금',
	'LOCK_POST_EXPLAIN'					=> '이전 편집',
	'LOCK_TOPIC'						=> '주제 잠금',
	'LOGIN'							=> '로그인',
	'LOGIN_CHECK_PM'	=> '로그인 해서 비공개 메시지 보세요.',
	...
	'LOGIN_ERROR_ATTEMPTS'	=> '허용된 최대 로그인 시도 횟수를 넘었습니다. 사용자 이름과 암호 외에도 CAPTCHA 테스트를 통과해야 합니다.',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> '아파치에서 인증하지 않음.',
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> '없는 OAuth 서비스 요청.',
	'LOGIN_ERROR_PASSWORD'	=> '틀린 암호를 지정했습니다. 암호를 확인하고 다시 시도해 주세요. 문제가 계속되면 %s게시판 관리자%s에게 연락하십시오..',
